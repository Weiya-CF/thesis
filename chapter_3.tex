\chapter{Navigation for Co-located Users in Limited Workspace}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/3_initial_config}
...
\begin{figure*}[tb]
  \centering
  \includegraphics[width=0.48\textwidth]{figures/3_HAC}
  \includegraphics[width=0.48\textwidth]{figures/3_SWO}
  \includegraphics[width=0.48\textwidth]{figures/3_ESP}
  \includegraphics[width=0.48\textwidth]{figures/3_UO}
