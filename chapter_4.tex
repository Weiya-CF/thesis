...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/ch4/t1}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/ch4/t2}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/ch4/t3}
  \caption{\label{fig:4_task3}A screen-shot of the virtual scene used in Experiment TR.}
\end{figure}

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/ch4/t3_q}
