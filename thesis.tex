...
% added by Weiya Chen
\usepackage{rotating} % verticle tables
\usepackage{minitoc} % table of contents for each chapter
\setcounter{secnumdepth}{3}
\setcounter{tocdepth}{3}
%\setlength{\headheight}{27.75pt} % chapter title more than one line cause margin problem
